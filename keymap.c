...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LBASE] = {
		...
		{ KC_LSPO, xxxxxxx, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, xxxxxxx, KC_RSFT },
		{ KC_LCTL, KLOCK  , KC_LALT, xxxxxxx, xxxxxxx, KC_SPC , xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, MO(LFN), KC_RALT, KC_RGUI, KC_RCTL }
	},
	/* 1: fn */
	[LFN] = {
